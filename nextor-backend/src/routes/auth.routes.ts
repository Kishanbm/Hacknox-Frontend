...
import { signup, login, verifyEmail, logout, me, editMyProfile, updateEmailPreferencesController, updatePasswordController, getUserById } from "../controllers/auth/auth.controller";
...
router.get("/user/:id", verifyAuthToken, getUserById);
